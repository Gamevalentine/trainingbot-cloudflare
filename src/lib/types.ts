...
export interface AppRecord {
  ...
  category_id:number|null; category_name?:string; category_slug?:string; status:AppStatus; visibility:Visibility; featured:number;
  pricing_type:string; platform:string; tech_stack:string; version:string; search_keywords:string; monitor_enabled:number; last_checked_at:string; last_http_status:number|null; last_response_ms:number|null; last_error:string; created_at:string; updated_at:string;
