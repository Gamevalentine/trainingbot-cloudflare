(()=>{
  ...
  style.textContent=`
    ...
    #tbWikiGrid .tb-wiki-card{height:310px!important;min-height:310px!important;max-height:310px!important;display:flex!important;flex-direction:column!important;padding:0 14px 14px!important;overflow:hidden!important;content-visibility:auto;contain-intrinsic-size:310px 280px}
    #tbWikiGrid .tb-card-tag{left:14px!important;top:14px!important;z-index:5!important}
    #tbWikiGrid .tb-card-visual{width:100%!important;height:154px!important;min-height:154px!important;max-height:154px!important;margin:14px 0 10px!important;padding:12px!important;border:1px solid rgba(255,148,82,.18)!important;border-radius:14px!important;background:linear-gradient(145deg,#c9a58f,#aa8068)!important;display:flex!important;align-items:center!important;justify-content:center!important;overflow:hidden!important;box-sizing:border-box!important}
    ...
    @media(max-width:700px){
      #tbWikiGrid .tb-wiki-card{height:244px!important;min-height:244px!important;max-height:244px!important;padding:0 8px 10px!important;contain-intrinsic-size:244px 180px}
