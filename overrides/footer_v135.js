(()=>{
  ...
  footer.innerHTML=`<div class="tb-global-footer-inner">
    ...
    <section><h2>LIÊN HỆ</h2><nav>
      ...
      <a href="https://www.facebook.com/profile.php?id=61594602669110&amp;sk=directory_contact_info" target="_blank" rel="noopener noreferrer"><svg aria-hidden="true" viewBox="0 0 24 24" width="17" height="17" fill="currentColor"><path d="M13.5 22v-9h3l.5-3.5h-3.5V7.25c0-1.02.28-1.72 1.75-1.72H17.2V2.4c-.34-.05-1.5-.15-2.85-.15-2.82 0-4.75 1.72-4.75 4.88V9.5H6.4V13h3.2v9h3.9Z"/></svg><span>Facebook</span></a>
    </nav></section>
  </div>`;
